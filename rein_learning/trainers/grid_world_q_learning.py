from ..agents import QLearningConfig, TabularQLearningAgent
from ..envs import SmallGridWorldEnv


def train(num_episodes: int = 500) -> TabularQLearningAgent:
...
def evaluate(agent: TabularQLearningAgent) -> None:
    ...
    print("Greedy Q-learning evaluation:")
    print(env.render())
