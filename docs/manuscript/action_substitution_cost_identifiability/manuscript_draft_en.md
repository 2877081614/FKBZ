...
Manuscript status: W1-09 complete English draft  
...
in `time_pressure/resource`. Cost-sign masking nevertheless occurred in only 2 of 9 missile
contexts and 5 of 9 laser contexts, so the preregistered cross-resource gate failed. More
...
protocol selected six safety and six resource contexts; each resource slot contained three
missile and three laser contexts. The final 108 contexts had zero observation-hash overlap with
...
<!-- RES-6.5-03 -->
Mean cost-sign masking occurred in 2 of 9 missile contexts and 5 of 9 laser contexts. Missile
...
identify all state-mediated paths, unobserved mediators, or policy-training effects.
